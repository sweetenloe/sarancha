...
*Analyze the code and change what you don't want deleted. It's pretty thorough.*

## Use: 
Make the script executable:

```bash
sudo chmod +x /usr/local/bin/sarancha-beta_v1.sh
```

Rename the script (if you want to), then run the script:
```
sudo ./sarancha-beta_v1.sh
```
